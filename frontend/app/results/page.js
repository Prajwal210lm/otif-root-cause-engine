...
export const metadata = {
  ...
  description: `${METRICS.overallPct}% overall accuracy. ${METRICS.ambiguousPct}% on the hard orders where two causes overlap. A simple rule manages only ${METRICS.naivePct}%.`,
};
